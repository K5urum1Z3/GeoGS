...
class ModelHiddenParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.use_geodesic_branch=False # enable geodesic motion branch (position/rotation/scale only)
        self.use_sphere_branch=True # enable sphere reference manifold branch
        self.use_hyper_branch=True # enable hyperbolic reference manifold branch
        self.geo_latent_dim=64 # latent dim for manifold state
        self.geo_step_size=0.01 # retraction-like step size for geodesic update
        self.geo_step_size_sphere=-1.0 # if <=0, fallback to geo_step_size
        self.geo_step_size_hyper=-1.0 # if <=0, fallback to geo_step_size
        self.geo_use_sphere_expmap=True # use sphere exponential-map style update
        self.geo_use_hyper_expmap=True # use poincare exponential-map style update
...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.geo_lr = 0.000025
        self.geo_lr_sphere = 0.000025
        self.geo_lr_hyper = 0.000025
        self.geo_lr_sphere_final = 0.0000025
        self.geo_lr_hyper_final = 0.0000025
        self.geo_lr_delay_mult = 0.01
